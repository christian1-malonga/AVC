...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "AVC — Amazing Voices Choir Management" },
      {
        name: "description",
        content: "St. Barnabas Amazing Voices Choir management portal — members, music, meetings, and more.",
      },
      { property: "og:title", content: "AVC — Amazing Voices Choir" },
      {
        property: "og:description",
        content: "Sing Praises to The Lord — the AVC management platform.",
      },
