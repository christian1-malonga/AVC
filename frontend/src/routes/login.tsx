...
<Button
            ...
            >
              ...
              <Button type="button" variant="outline" onClick={() => window.location.href = "http://localhost:5000/api/auth/google"} className="w-full h-11 border-border/70 bg-white/70 hover:bg-white">
