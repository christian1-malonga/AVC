...
const SECTIONS = [
  {
    id: "soprano",
    name: "Soprano",
    tagline: "Highest voices, bright & soaring",
    icon: Music4,
  ...
  },
  {
    id: "alto",
    name: "Alto",
    tagline: "Warm, rich middle range",
    icon: Music3,
  ...
  },
  {
    id: "tenor",
    name: "Tenor",
    tagline: "Bright male voices with power",
    icon: Music2,
  ...
  },
  {
    id: "bass",
    name: "Bass",
    tagline: "The deep foundation of harmony",
    icon: Music,
  ...
  async function handleContinue() {
    ...
    try {
      ...
      if (error?.response?.status === 403) {
        toast("Your section is already set.");
        return;
      }
      const message =
        error instanceof Error ? error.message : "Failed to set section. Please try again.";
      toast.error(message);
    } finally {
      setSaving(false);
    }
      ...
      <div className="relative w-full max-w-5xl">
        ...
        <div className="text-center mb-8 text-white">
          ...
          <p className="mt-2 text-white/80 text-sm">
            This helps us tailor your rehearsals and sheet music.
          </p>
        </div>
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {SECTIONS.map((s, i) => {
            ...
            return (
              ...
              >
                <div
                  className={`h-12 w-12 rounded-xl bg-gradient-to-br ${s.color} grid place-items-center text-white shadow-glow mb-4`}
                >
