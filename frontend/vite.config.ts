  ...
  vite: {
    ...
    server: {
      proxy: {
        ...
        "/voice-notes": { target: "http://127.0.0.1:4000", changeOrigin: true },
        "/receipts": { target: "http://127.0.0.1:4000", changeOrigin: true },
        "/audit-logs": { target: "http://127.0.0.1:4000", changeOrigin: true },
        "/birthdays": { target: "http://127.0.0.1:4000", changeOrigin: true },
      },
    },
  },
});
